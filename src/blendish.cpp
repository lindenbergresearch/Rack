...
static BNDtheme bnd_theme = {
        ...
        // sliderTheme
        {
         {{{0.098, 0.098, 0.098, 1}}}, // color_outline
                ...
                {{{0.706, 0.706, 0.706, 1}}}, // color_inner
                {{{00.1961, 0.4666, 0.8823, 0.7}}}, // color_inner_selected
                BND_COLOR_TEXT, // color_text
                BND_COLOR_TEXT_SELECTED, // color_text_selected
                -20, // shade_top
                0, // shade_down
        ...
        // scrollBarTheme
        {
         {{{0.196, 0.196, 0.196, 0.4}}}, // color_outline
                {{{0.102, 0.202, 0.502, 0.7}}}, // color_item
                {{{0.314, 0.314, 0.314, 0.906}}}, // color_inner
                {{{0.492,   0.492,  0.492,  0.906}}}, // color_inner_selected
                BND_COLOR_TEXT, // color_text
                BND_COLOR_TEXT_SELECTED, // color_text_selected
                3, // shade_top
                -3, // shade_down
        ...
        // menuTheme
        {
         {{{0.5,   0.5,   0.5,   0.3}}}, // color_outline
                {{{0.392, 0.392, 0.392, 1}}}, // color_item
                {{{0.15,  0.15,  0.15,  0.982}}}, // color_inner
                {{{0.176,   0.176,  0.976,  0.982}}}, // color_inner_selected
                {{{0.627, 0.627, 0.627, 1}}}, // color_text
                BND_COLOR_TEXT_SELECTED, // color_text_selected
                5, // shade_top
                -5, // shade_down
...
void bndMenuItem(NVGcontext *ctx,
    ...
    if (state != BND_DEFAULT) {
        bndInnerBox(ctx, x, y - 4, w, h + 4, 4, 4, 4, 4,
