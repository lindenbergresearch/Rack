...
static const float RACK_GRID_HEIGHT_SUB = 1;
static const float RACK_GRID_HEIGHT_ABSOLUTE = 380;
static const float RACK_GRID_HEIGHT = RACK_GRID_HEIGHT_ABSOLUTE / RACK_GRID_HEIGHT_SUB;
static const math::Vec RACK_GRID_SIZE = math::Vec(RACK_GRID_WIDTH, RACK_GRID_HEIGHT);
static const math::Vec RACK_OFFSET = RACK_GRID_SIZE.mult(math::Vec(1400, 50));
static const math::Vec BUS_BOARD_GRID_SIZE = math::Vec(500, RACK_GRID_HEIGHT);
